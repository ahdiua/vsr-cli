...
# --- 2b. akarin plugin (fast RIFE scene-change select) ----------------------
# RIFE must not interpolate across scene cuts; pipeline.vpy picks the original
...
log "  vsr doctor"
log "  vsr build-engines -i sample.mkv --upscale --model animejanaiV3-HD-L2.onnx"
log "  vsr run -i in.mkv -o out.mkv --upscale --model animejanaiV3-HD-L2.onnx --rife --rife-multi 2"
